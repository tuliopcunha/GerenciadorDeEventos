...
@section('titlesection', 'Eventos Disponíveis')
    ...
    <div class="col-md-6 col-xs-12 col-sm-12 col-lg-6 ">
        <div class="tab-content box box-success">
          <div class="tab-pane active box-body " id="home">
             @if(sizeof($eventosDisponiveis) == 0)
              <center><h2> Atualmente não há nenhum Evento Disponível para inscrição!</h2></center>
             @endif 
             @foreach($eventosDisponiveis as $eve)                   
                      <div class="small-box bg-primary">
                        <div class="inner">
                          ...
                          <input type="hidden" name="Codigo" value="{{ $eve->eveCod }}"></input>
                            <center>
                            <p>
                                <b>Inscrições :</b> Início: {{ date('d-m-y', strtotime($eve->eveDataIniInsc)) }} 
                                &nbsp;&nbsp;
                                Fim: {{date('d-m-y', strtotime($eve->eveDataFimInsc))}}
                                </p>
                            </center>
                          <a href="/eventos/{{$eve->eveNome}}/{{$eve->eveCod}}" class="small-box-footer">Inscrever-se&nbsp;<i class="fa fa-arrow-circle-right"></i>
                          </a>
                      </div>
     ...
     $(function () {
        ...
        $('#calendar').fullCalendar({
          ...
          events: [
          @foreach ($eventosDisponiveis as $eD)
          {
